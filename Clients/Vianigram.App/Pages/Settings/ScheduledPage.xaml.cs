...
// ScheduledPage.xaml.cs — code-behind only handles plumbing.
...
namespace Vianigram.App.Pages.Settings
{
    ...
    {
        private ScheduledPageViewModel _vm;
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
                _vm = AppViewModels.CreateScheduledPageViewModel(App.Composition);
                DataContext = _vm;
            }
