...
// PasscodePage.xaml.cs — code-behind is intentionally minimal.
...
namespace Vianigram.App.Pages.Auth
{
    ...
    {
        private PasscodePageViewModel _vm;
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (_vm == null)
            {
                _vm = AppViewModels.CreatePasscodePageViewModel(App.Composition);
                DataContext = _vm;
            }
