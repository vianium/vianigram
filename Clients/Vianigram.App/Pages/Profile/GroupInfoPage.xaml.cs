...
// GroupInfoPage.xaml.cs — code-behind is intentionally minimal.
...
namespace Vianigram.App.Pages.Profile
{
    ...
    {
        private GroupInfoPageViewModel _vm;
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (_vm == null)
            {
                _vm = AppViewModels.CreateGroupInfoPageViewModel(App.Composition);
                DataContext = _vm;
            }
